...
function M.setup()
  ...
  theme.highlights = {
    ...
    ColorColumn = { bg = c.grey }, -- used for the columns set with 'colorcolumn'
    ...
    Directory = { fg = c.fg_sidebar }, -- directory names (and other special names in listings)
    ...
    LineNr = { fg = c.aqua }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    NvimTreeFolderIcon = { fg = c.pink, bg = c.none },
